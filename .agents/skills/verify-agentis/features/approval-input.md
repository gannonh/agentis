...
For the input artifact check, set `STATUS_FILE="$EVIDENCE_DIR/input-after.json"` and `EXPECTED_BRIEF="KAT-3315 input"` before using the [shared byte/hash check](../references/manual-session.md#artifact-byte-and-hash-check).
