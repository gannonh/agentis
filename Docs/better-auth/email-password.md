...
If you prefer username-based authentication, check out the [username plugin](/docs/plugins/username). It extends the email and password authenticator with username support.
