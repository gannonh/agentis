...
**Dependencies**: None  
**Acceptance Criteria**:
- [ ] Fix `handleOrganizationAssignment` function call parameters
- [ ] Verify organizations are created correctly via hooks
- [ ] Add error handling for hook failures
- [ ] Unit tests for organization assignment logic
...
**Dependencies**: None  
**Acceptance Criteria**:
- [ ] Create service using existing public-email-domains.txt
- [ ] Implement efficient domain lookup (Set-based)
- [ ] Add subdomain handling (mail.google.com → google.com)
- [ ] Support domain extraction from email addresses
