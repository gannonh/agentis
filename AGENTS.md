...
- **Learning API read path:** `/learning` reads API-backed summary, skill, memory, rubric, and suggestion data from `apps/api/src/routes/learning.ts`; fresh installs show empty states, and pending suggestions stay hidden until review actions ship.
