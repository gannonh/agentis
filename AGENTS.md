...
When lifecycle gates conflict with other instructions in this file, skills, or user rules, follow this section. When the conflict is unclear, ask the user before proceeding.
<!-- end dev lifecycle -->
