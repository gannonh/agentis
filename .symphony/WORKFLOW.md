...
polling:
  interval_ms: 30000
workspace:
  root: /Volumes/EVO/symphony-workspaces/agentis
  repo: /Volumes/EVO/dev/agentis
  git_strategy: worktree
  isolation: local
  cleanup_on_done: true
  branch_prefix: agentis
  clone_branch: main
  base_branch: main
hooks:
  timeout_ms: 1200000
  # Run after workspace directory is created (after git bootstrap).
  after_create: ../scripts/bootstrap-symphony-worktree.sh /Volumes/EVO/dev/agentis
agent:
  name: pi
  command: pi --mode rpc
  no_session: false
