...
const startServer = async () => {
  ...
  /* Organization detection endpoint moved to organizationJoin router */

  /* Enable domain join endpoint moved to organizationJoin router */
  ...
  app.use('/api/organization', routes.organizationJoin);
