...
export const ProgressiveRegistration: React.FC = () => {
  ...
  useEffect(() => {
    if (session?.user) {
      ...
      if (state?.currentStep === RegistrationStep.EMAIL || 
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                        ...
                        <p className="mt-1">No passwords needed - just click the link in your email!</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-green-700 dark:text-green-300">
                        <p>We've sent a magic link to <strong>{state?.email || ''}</strong></p>
                        <p className="mt-1">Click the link to sign in instantly and continue your setup.</p>
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    className="text-sm text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 underline disabled:opacity-50"
                  >
          ...
          <div className="space-y-4">
            ...
            <input
              {...register('organizationSlug', {
                ...
                pattern: {
                  ...
                  message: 'Must start and end with letter/number, can contain letters, numbers, hyphens, and periods',
                },
                minLength: {
                  value: 2,
              ...
              aria-label="Organization URL"
                ...
                defaultValue={(state?.organizationData?.domain || state?.email?.split('@')[1] || '').replace(/\./g, '-')}
                className="webkit-dark-styles transition-color peer w-full rounded-2xl border border-border-light bg-surface-primary px-3.5 pb-2.5 pt-3 text-text-primary duration-200 focus:border-green-500 focus:outline-none"
                placeholder=" "
              />
              <label
            ...
            <textarea
              ...
              aria-label="Organization description"
                className="webkit-dark-styles transition-color peer w-full rounded-2xl border border-border-light bg-surface-primary px-3.5 pb-2.5 pt-3 text-text-primary duration-200 focus:border-green-500 focus:outline-none resize-none"
                placeholder=" "
              rows={3}
            />
              <label
    ...
    return (
      <div className="mb-8">
        ...
        <div className="mt-4 flex justify-between">
          {['Email', 'Magic Link', 'Organization', 'Profile', 'Welcome'].map(
            (step, index) => (
              <span
                key={step}
                className={cn(
          ...
          <div className="ml-auto flex gap-2">
            {canSkip() && (
              <button
                ...
                disabled={isSubmitting}
                className="inline-flex p-1 text-sm font-medium text-green-600 transition-colors hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 disabled:opacity-50"
              >
                Skip
              </button>
            )}
