        ...
        <div className="w-full max-w-md space-y-6 rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Welcome to <strong>{invitation.organizationName}</strong>! You&apos;ll be redirected
              to the main application shortly.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="text-center">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                <strong>{invitation.inviterName}</strong> has invited you to join their organization
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6 rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Join {invitation.organizationName}</p>
        </div>
