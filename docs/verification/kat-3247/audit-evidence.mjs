...
const scope = ["docs/verification/kat-3247", "docs/verification/verify-agentis/acceptance/kat-3247-e2085e98", "docs/verification/verify-agentis/acceptance/kat-3247-completion-20260911"];
...
const dataRoots = ["kat-3243-validation-v3", "kat-3247-e2085e98", "kat-3247-rejection-e2085e98", "kat-3247-recovery-e2085e98", "kat-3247-completion-20260911", "kat-3247-completion-rejection-20260911", "kat-3247-completion-recovery-20260911"].map(name => `/Users/gannonhall/.agentis/${name}`);
...
const receipt = {
  ...
  scope,
  ownerTokenScan: { fileCount: files.length, comparison: "Literal owner token contents from the seven named local data roots; filenames and paths are retained as provenance", dataRoots, additionalPattern: apiKeyPattern.source, matches, status: matches.length ? "FAIL" : "PASS" },
...
writeFileSync("docs/verification/kat-3247/evidence/repaired/cleanup-and-redaction.json", JSON.stringify(receipt, null, 2) + "\n");
