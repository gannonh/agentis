...
- `docs/verification/kat-3243/evidence/responses/codex-quota-protocol-fixture.json` - Deterministic Codex quota fixture for KAT-3302. Typed `quota` at SHA `18ee190b9c9a9d76948d2ee544c93aa0d72ec833`. Not a live billing receipt.
...
- Claude quota and crash remain deterministic stub fixtures. Codex quota is the KAT-3302 protocol fixture (`fixtureMode=true`, SHA `18ee190b9c9a9d76948d2ee544c93aa0d72ec833`). No real account quota was exhausted.
