...
- [Codex quota protocol fixture](evidence/responses/codex-quota-protocol-fixture.json): deterministic `QUOTA` brief, typed `quota`, no artifact, no live billing. Log: [codex-quota-protocol-fixture.log](evidence/logs/codex-quota-protocol-fixture.log).
