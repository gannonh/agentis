...
| Later gates | Create explicit child specs and a verification issue after predecessor passes; scheduled repeat use includes five daily workflow runs in each of two consecutive weeks for the initial operator | [KAT-3237](https://linear.app/kata-sh/issue/KAT-3237) epic until a verification issue exists |
