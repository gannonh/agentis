...
The September 11 [KAT-3247 exact-SHA report](kat-3247/README.md) records both live provider suites, accepted handoff, concurrency, local packaged smoke and Linux core CI at `e2085e98c27d530b0c9e66224d07e853f68f5f17`. Overall Gate 0 remains **UNVERIFIED**. Live rejected-handoff ownership and fixture isolation retain explicit gaps. Fixture reconnect/restart and live history loading do not certify real-resource recovery. Gate 1 remains blocked.
