...
**Purpose:** Primary roadmap for implementation specs and ordered vertical slices to close meaningful gaps between [HyperAgent](https://hyperagent.com) and Agentis. Each slice is demo-able, scoped for a single GitHub issue, and safe for parallel agent execution.
...
**How to use:** Pick a slice → create or update a spec in this directory, create a GitHub issue from the template at the bottom, then implement in an isolated worktree.
...
**Status:** Shipped (2026-06-13). Spec: [2026-06-13-thread-working-artifacts-design.md](2026-06-13-thread-working-artifacts-design.md).
...
```markdown
## Context
HyperAgent gap slice from `docs/specs/index.md` (**HA-GAP-XX**).
...
gh issue create --repo gannonh/agentis \
  ...
  --body "$(cat <<'EOF'
## Context
HyperAgent gap slice HA-GAP-08 from docs/specs/index.md
...
Implementation specs, design docs, and build reports. Completed work lives in `_done/`.
...
| [2026-05-30-agent-native-tooling-v2-safe-file-edits.md](_done/2026-05-30-agent-native-tooling-v2-safe-file-edits.md) | V2 safe file edits |
| [2026-05-31-agent-native-tooling-v4-1-web-search-design.md](_done/2026-05-31-agent-native-tooling-v4-1-web-search-design.md) | V4.1 web search |
| [2026-06-01-document-workspace-design.md](_done/2026-06-01-document-workspace-design.md) | Document workspace UI |
| [2026-06-01-agent-native-tooling-v4-2-persistent-documents-design.md](_done/2026-06-01-agent-native-tooling-v4-2-persistent-documents-design.md) | V4.2 persistent documents |
| [2026-06-02-migrate-chat-model-execution-to-vercel-ai-gateway-design.md](_done/2026-06-02-migrate-chat-model-execution-to-vercel-ai-gateway-design.md) | Vercel AI Gateway migration |
| [2026-06-04-configurable-ai-gateway-migration-design.md](_done/2026-06-04-configurable-ai-gateway-migration-design.md) | Configurable AI Gateway |
| [2026-06-04-cloudflare-ai-gateway-poc-design.md](_done/2026-06-04-cloudflare-ai-gateway-poc-design.md) | Cloudflare AI Gateway POC |
| [2026-06-04-library-artifact-domain-refactor-design.md](_done/2026-06-04-library-artifact-domain-refactor-design.md) | Library artifact domain refactor |
| [2026-06-04-agent-native-tooling-v4-static-artifacts-design.md](_done/2026-06-04-agent-native-tooling-v4-static-artifacts-design.md) | V4 static webpages and slides |
| [2026-06-04-agent-native-tooling-v4-apps-design.md](_done/2026-06-04-agent-native-tooling-v4-apps-design.md) | V4 App artifact runtime |
| [2026-06-04-agent-native-tooling-v4-apps-design-build-report.md](_done/2026-06-04-agent-native-tooling-v4-apps-design-build-report.md) | App runtime build report |
